...
const Navbar = () => {
  ...
  return (
    <nav className='p-5 shadow-lg border-b-4 border-b-yellow md:flex md:items-center md:justify-between sticky top-0 z-10'> 
      <div className='flex justify-between items-center'>
        <Link to='/' className='text-4xl text-gray-400 font-[poppins] cursor-pointer'>
          <h3 className='text-grey'><span className='text-yellow'>N</span>amnai <span className='text-yellow'>P</span>roject</h3>
        </Link>
